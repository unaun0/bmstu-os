...
Закрыть все ненужные файловые дескрипторы для предотвращения удержания в открытом состоянии некоторых дескрипторов, унаследованных от родительского процесса.